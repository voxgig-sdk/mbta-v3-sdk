...
class ScheduleEntity
  ...
  #
  # @param reqmatch [ScheduleLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Schedule.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Schedule, Hash] the loaded Schedule; raises MbtaV3Error on failure
