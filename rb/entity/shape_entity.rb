...
class ShapeEntity
  ...
  # @return [Shape, Hash] the current Shape data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Shape fields)
  def match_get
  ...
  # Load a single Shape.
  #
  # @param reqmatch [ShapeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Shape.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Shape, Hash] the loaded Shape; raises MbtaV3Error on failure
