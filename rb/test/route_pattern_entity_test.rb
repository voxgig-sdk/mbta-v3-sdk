...
class RoutePatternEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MBTAV__TEST_ROUTE_PATTERN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def route_pattern_basic_setup(extra)
  ...
  entid_env_raw = ENV["MBTAV__TEST_ROUTE_PATTERN_ENTID"]
