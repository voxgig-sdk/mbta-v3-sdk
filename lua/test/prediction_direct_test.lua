...
describe("PredictionDirect", function()
  it("should direct-load-prediction", function()
    local setup = prediction_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-prediction", setup.live and "live" or "unit")
...
function prediction_direct_setup(mockres)
