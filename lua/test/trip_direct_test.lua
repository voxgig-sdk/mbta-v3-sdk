...
describe("TripDirect", function()
  it("should direct-load-trip", function()
    local setup = trip_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-trip", setup.live and "live" or "unit")
...
function trip_direct_setup(mockres)
