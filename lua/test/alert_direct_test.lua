...
describe("AlertDirect", function()
  it("should direct-load-alert", function()
    local setup = alert_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-alert", setup.live and "live" or "unit")
