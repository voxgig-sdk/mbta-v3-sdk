...
describe("PredictionEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MBTAV__TEST_PREDICTION_ENTID JSON to run live")
      return
    end
...
function prediction_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MBTAV__TEST_PREDICTION_ENTID")
