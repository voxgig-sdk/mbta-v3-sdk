...
describe("RoutePatternDirect", function()
  it("should direct-load-route_pattern", function()
    local setup = route_pattern_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-route_pattern", setup.live and "live" or "unit")
...
function route_pattern_direct_setup(mockres)
