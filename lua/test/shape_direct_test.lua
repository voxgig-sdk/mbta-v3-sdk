...
describe("ShapeDirect", function()
  it("should direct-load-shape", function()
    local setup = shape_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-shape", setup.live and "live" or "unit")
...
function shape_direct_setup(mockres)
