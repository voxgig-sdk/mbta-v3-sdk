...
describe("VehicleEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MBTA_V3_TEST_VEHICLE_ENTID JSON to run live")
      return
    end
...
function vehicle_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MBTA_V3_TEST_VEHICLE_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["MBTA_V3_TEST_VEHICLE_ENTID"])
