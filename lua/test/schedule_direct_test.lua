...
describe("ScheduleDirect", function()
  it("should direct-load-schedule", function()
    local setup = schedule_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-schedule", setup.live and "live" or "unit")
