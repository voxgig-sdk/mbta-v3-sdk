...
describe("AlertEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MBTAV__TEST_ALERT_ENTID JSON to run live")
      return
    end
...
function alert_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MBTAV__TEST_ALERT_ENTID")
