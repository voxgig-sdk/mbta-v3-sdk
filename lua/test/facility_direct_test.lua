...
describe("FacilityDirect", function()
  it("should direct-load-facility", function()
    local setup = facility_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-facility", setup.live and "live" or "unit")
...
function facility_direct_setup(mockres)
