...
local FacilityEntity = {}
FacilityEntity.__index = FacilityEntity


function FacilityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FacilityEntity)
  self._name = "facility"
  self._client = client
...
function FacilityEntity:get_name()
  return self._name
end


function FacilityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FacilityEntity.new(self._client, opts)
end
...
function FacilityEntity:mark_deleted()
  self._deleted = true
end


function FacilityEntity:deleted()
  return true == self._deleted
end


function FacilityEntity:data_set(args)
  if args ~= nil then
...
function FacilityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FacilityEntity:match_set(args)
  if args ~= nil then
...
function FacilityEntity:match_get()
...
function FacilityEntity:stream(action, args, callopts)
...
---@param reqmatch FacilityLoadMatch
---@param ctrl? table
---@return Facility
---@return string? err
function FacilityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FacilityEntity:_run_op(ctx, post_done)
  local utility = self._utility
