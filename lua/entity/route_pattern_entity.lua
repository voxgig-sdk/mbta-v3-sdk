...
local RoutePatternEntity = {}
RoutePatternEntity.__index = RoutePatternEntity


function RoutePatternEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RoutePatternEntity)
  self._name = "route_pattern"
  self._client = client
...
function RoutePatternEntity:get_name()
  return self._name
end


function RoutePatternEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RoutePatternEntity.new(self._client, opts)
end
...
function RoutePatternEntity:mark_deleted()
  self._deleted = true
end


function RoutePatternEntity:deleted()
  return true == self._deleted
end


function RoutePatternEntity:data_set(args)
  if args ~= nil then
...
function RoutePatternEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RoutePatternEntity:match_set(args)
  if args ~= nil then
...
function RoutePatternEntity:match_get()
...
function RoutePatternEntity:stream(action, args, callopts)
...
---@param reqmatch RoutePatternLoadMatch
---@param ctrl? table
---@return RoutePattern
---@return string? err
function RoutePatternEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RoutePatternEntity:_run_op(ctx, post_done)
  local utility = self._utility
