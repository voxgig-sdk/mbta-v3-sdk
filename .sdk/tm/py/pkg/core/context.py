...
from projectname_sdk.core.control import MbtaV3Control
...
class MbtaV3Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, MbtaV3Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MbtaV3Error(code, msg, self)
