# MbtaV3 SDK primary utility test
...
from projectname_sdk import MbtaV3SDK
from projectname_sdk.core.spec import MbtaV3Spec
from projectname_sdk.core.result import MbtaV3Result
from projectname_sdk.core.response import MbtaV3Response
from projectname_sdk.core.operation import MbtaV3Operation
from projectname_sdk.core.error import MbtaV3Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MbtaV3BaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MbtaV3SDK.test(None, None)
        ...
        class TestInitFeature(MbtaV3BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MbtaV3BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MbtaV3Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MbtaV3SDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MbtaV3SDK.test(None, setup_opts)
