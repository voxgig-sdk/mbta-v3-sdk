...
describe('exists', async () => {
  ...
  //
  // MbtaV3SDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof MbtaV3SDK, true,
      'MbtaV3SDK.test() must return a client synchronously')
  })
