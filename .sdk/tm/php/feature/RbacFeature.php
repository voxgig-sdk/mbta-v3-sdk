...
class MbtaV3RbacFeature extends MbtaV3BaseFeature
{
    ...
    private function _required(MbtaV3Context $ctx): ?string
    {
    ...
    private function _reject(MbtaV3Context $ctx, string $required): void
    {
    ...
    private function _track(MbtaV3Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
