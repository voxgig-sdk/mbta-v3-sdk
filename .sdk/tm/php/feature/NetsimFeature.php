...
class MbtaV3NetsimFeature extends MbtaV3BaseFeature
{
    ...
    private function _simulate(MbtaV3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MbtaV3Context $ctx, array $applied): void
    {
        $client = $this->client;
