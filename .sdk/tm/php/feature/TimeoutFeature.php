...
class MbtaV3TimeoutFeature extends MbtaV3BaseFeature
{
    ...
    private function _with_timeout(MbtaV3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MbtaV3Context $_ctx, float $ms): void
    {
        $client = $this->client;
