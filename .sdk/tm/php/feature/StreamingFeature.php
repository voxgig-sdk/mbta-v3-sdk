...
class MbtaV3StreamingFeature extends MbtaV3BaseFeature
{
    ...
    private function _iterate(MbtaV3Result $result): \Generator
    {
    ...
    private function _streamable(MbtaV3Context $ctx): bool
    {
