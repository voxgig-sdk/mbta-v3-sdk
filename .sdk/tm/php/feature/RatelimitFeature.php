...
class MbtaV3RatelimitFeature extends MbtaV3BaseFeature
{
    ...
    private function _acquire(MbtaV3Context $ctx): void
    {
    ...
    private function _track(MbtaV3Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
