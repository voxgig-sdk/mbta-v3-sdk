...
class MbtaV3Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MbtaV3SDK/1.0)';
    ...
    public static function call(MbtaV3Context $ctx, string $fullurl, array $fetchdef): array
    {
