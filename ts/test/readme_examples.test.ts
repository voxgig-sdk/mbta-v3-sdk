...
//     (\`new MbtaV3SDK(...)\` / \`MbtaV3SDK.test(...)\` become
//     \`MbtaV3SDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"alert":{"test01":{"id":"test01"}},"facility":{"test01":{"id":"test01"}},"line":{"test01":{"id":"test01"}},"prediction":{"test01":{"id":"test01"}},"route":{"test01":{"id":"test01"}},"route_pattern":{"test01":{"id":"test01"}},"schedule":{"test01":{"id":"test01"}},"service":{"test01":{"id":"test01"}},"shape":{"test01":{"id":"test01"}},"stop":{"test01":{"id":"test01"}},"trip":{"test01":{"id":"test01"}},"vehicle":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new MbtaV3SDK(...)\` and any
// \`MbtaV3SDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+MbtaV3SDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/MbtaV3SDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
