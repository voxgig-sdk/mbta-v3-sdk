...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MBTA_V3_TEST_LIVE ||
    'TRUE' === process.env.MBTA_V3_TEST_OVERRIDE
  ) {
  ...
  m.MBTA_V3_TEST_EXPLAIN = process.env.MBTA_V3_TEST_EXPLAIN || m.MBTA_V3_TEST_EXPLAIN
