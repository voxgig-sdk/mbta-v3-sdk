...
describe('ShapeDirect', async () => {
  ...
  test('direct-load-shape', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-shape', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MBTA_V3_TEST_SHAPE_ENTID']
