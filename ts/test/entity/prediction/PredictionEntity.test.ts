...
describe('PredictionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set MBTA_V__TEST_PREDICTION_ENTID JSON to run live')
      return
    }
    ...
    const prediction_ref01_data_dt0 = await prediction_ref01_ent.load(prediction_ref01_match_dt0)
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['MBTA_V__TEST_PREDICTION_ENTID']
