...
describe('FacilityDirect', async () => {
  ...
  test('direct-load-facility', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-facility', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MBTA_V3_TEST_FACILITY_ENTID']
