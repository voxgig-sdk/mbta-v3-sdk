...
class TestScheduleDirect:
    ...
    def test_should_direct_load_schedule(self):
        setup = _schedule_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-schedule", "live" if setup["live"] else "unit")
        if _skip:
