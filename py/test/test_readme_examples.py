# MbtaV3 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MbtaV3SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MbtaV3SDK(...) and MbtaV3SDK.test(...) become
#      MbtaV3SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mbtav3_sdk"
_SDK_CLASS = "MbtaV3SDK"
