...
func registerSDKWords(r *eng.Registry, client *sdk.MbtaV3SDK) {
...
func runOp(client *sdk.MbtaV3SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
