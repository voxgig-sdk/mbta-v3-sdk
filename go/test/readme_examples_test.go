...
const testSeed = `map[string]any{"entity": map[string]any{"alert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "facility": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "line": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "prediction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "route": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "route_pattern": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "service": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "shape": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stop": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trip": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vehicle": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
