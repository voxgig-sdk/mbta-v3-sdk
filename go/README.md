...
The Golang SDK for the MbtaV3 API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/mbta-v3-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/mbta-v3-sdk=../path/to/github.com/voxgig-sdk/mbta-v3-sdk
```
...
```
github.com/voxgig-sdk/mbta-v3-sdk/
...
The root package (`github.com/voxgig-sdk/mbta-v3-sdk`) re-exports everything needed
