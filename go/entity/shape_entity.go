...
func NewShapeEntity(client *core.MbtaV3SDK, entopts map[string]any) *ShapeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShapeEntity) GetName() string { return e.name }
...
func (e *ShapeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShapeEntity) Deleted() bool {
	return e.deleted
}


func (e *ShapeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShapeEntity(e.client, opts)
}

func (e *ShapeEntity) Data(args ...any) any {
...
func (e *ShapeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ShapeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShapeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ShapeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShapeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShapeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShapeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
