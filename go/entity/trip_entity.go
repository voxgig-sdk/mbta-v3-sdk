...
func NewTripEntity(client *core.MbtaV3SDK, entopts map[string]any) *TripEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TripEntity) GetName() string { return e.name }
...
func (e *TripEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TripEntity) Deleted() bool {
	return e.deleted
}


func (e *TripEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTripEntity(e.client, opts)
}

func (e *TripEntity) Data(args ...any) any {
...
func (e *TripEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Trip; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TripEntity) DataTyped(data ...Trip) Trip {
	if len(data) > 0 {
		return typedFrom[Trip](e.Data(asMap(data[0])))
	}
	return typedFrom[Trip](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Trip (all fields
// optional at the wire level).
func (e *TripEntity) MatchTyped(match ...Trip) Trip {
	if len(match) > 0 {
		return typedFrom[Trip](e.Match(asMap(match[0])))
	}
	return typedFrom[Trip](e.Match())
}
...
func (e *TripEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TripEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TripLoadMatch and returns an Trip. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TripEntity) LoadTyped(reqmatch TripLoadMatch, ctrl map[string]any) (Trip, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Trip{}, err
	}
	return typedFrom[Trip](res), nil
}



func (e *TripEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TripEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TripEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TripEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TripEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
