...
func NewFacilityEntity(client *core.MbtaV3SDK, entopts map[string]any) *FacilityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FacilityEntity) GetName() string { return e.name }
...
func (e *FacilityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FacilityEntity) Deleted() bool {
	return e.deleted
}


func (e *FacilityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFacilityEntity(e.client, opts)
}

func (e *FacilityEntity) Data(args ...any) any {
...
func (e *FacilityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Facility; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FacilityEntity) DataTyped(data ...Facility) Facility {
	if len(data) > 0 {
		return typedFrom[Facility](e.Data(asMap(data[0])))
	}
	return typedFrom[Facility](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Facility (all fields
// optional at the wire level).
func (e *FacilityEntity) MatchTyped(match ...Facility) Facility {
	if len(match) > 0 {
		return typedFrom[Facility](e.Match(asMap(match[0])))
	}
	return typedFrom[Facility](e.Match())
}
...
func (e *FacilityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FacilityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FacilityLoadMatch and returns an Facility. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FacilityEntity) LoadTyped(reqmatch FacilityLoadMatch, ctrl map[string]any) (Facility, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Facility{}, err
	}
	return typedFrom[Facility](res), nil
}



func (e *FacilityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FacilityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FacilityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FacilityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FacilityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
