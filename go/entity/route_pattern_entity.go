...
type RoutePatternEntity struct {
	name    string
	client  *core.MbtaV3SDK
...
func NewRoutePatternEntity(client *core.MbtaV3SDK, entopts map[string]any) *RoutePatternEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RoutePatternEntity) GetName() string { return e.name }
...
func (e *RoutePatternEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RoutePatternEntity) Deleted() bool {
	return e.deleted
}


func (e *RoutePatternEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRoutePatternEntity(e.client, opts)
}

func (e *RoutePatternEntity) Data(args ...any) any {
...
func (e *RoutePatternEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RoutePattern; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RoutePatternEntity) DataTyped(data ...RoutePattern) RoutePattern {
	if len(data) > 0 {
		return typedFrom[RoutePattern](e.Data(asMap(data[0])))
	}
	return typedFrom[RoutePattern](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RoutePattern (all fields
// optional at the wire level).
func (e *RoutePatternEntity) MatchTyped(match ...RoutePattern) RoutePattern {
	if len(match) > 0 {
		return typedFrom[RoutePattern](e.Match(asMap(match[0])))
	}
	return typedFrom[RoutePattern](e.Match())
}
...
func (e *RoutePatternEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RoutePatternEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RoutePatternLoadMatch and returns an RoutePattern. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RoutePatternEntity) LoadTyped(reqmatch RoutePatternLoadMatch, ctrl map[string]any) (RoutePattern, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RoutePattern{}, err
	}
	return typedFrom[RoutePattern](res), nil
}



func (e *RoutePatternEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RoutePatternEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RoutePatternEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RoutePatternEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RoutePatternEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
