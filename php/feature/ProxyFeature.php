...
class MbtaV3ProxyFeature extends MbtaV3BaseFeature
{
    ...
    public function init(MbtaV3Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MbtaV3Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
