...
// MbtaV3 SDK clienttrack feature
...
class MbtaV3ClienttrackFeature extends MbtaV3BaseFeature
{
    ...
    public function PostConstruct(MbtaV3Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MbtaV3-SDK';
