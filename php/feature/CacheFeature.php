...
class MbtaV3CacheFeature extends MbtaV3BaseFeature
{
    ...
    private function _through(MbtaV3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
