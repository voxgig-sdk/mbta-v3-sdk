...
// MbtaV3 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MbtaV3TestFeature extends MbtaV3BaseFeature
{
    ...
    public function init(MbtaV3Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MbtaV3Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MbtaV3Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MbtaV3Context $ctx, $op, $args): array
    {
