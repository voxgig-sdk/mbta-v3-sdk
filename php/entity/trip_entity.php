...
class TripEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TripEntity($this->_client, $opts);
    }

    /**
     * @param Trip|array $args Trip data (assoc-array) to store.
     */
    ...
    /**
     * @return Trip|array The current Trip data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Trip fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Trip fields).
     */
     ...
     * Load a single Trip.
     *
     * @param TripLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TripLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Trip|array The loaded Trip as an assoc-array at the
