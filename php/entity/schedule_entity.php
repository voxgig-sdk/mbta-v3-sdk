...
class ScheduleEntity
{
     ...
     *
     * @param ScheduleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ScheduleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Schedule|array The loaded Schedule as an assoc-array at the
