...
class ShapeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShapeEntity($this->_client, $opts);
    }

    /**
     * @param Shape|array $args Shape data (assoc-array) to store.
     */
    ...
    /**
     * @return Shape|array The current Shape data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Shape fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Shape fields).
     */
     ...
     * Load a single Shape.
     *
     * @param ShapeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ShapeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Shape|array The loaded Shape as an assoc-array at the
