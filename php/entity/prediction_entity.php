...
class PredictionEntity
{
     ...
     *
     * @param PredictionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PredictionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Prediction|array The loaded Prediction as an assoc-array at the
