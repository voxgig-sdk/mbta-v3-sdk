...
class AlertEntity
{
     ...
     * Load a single Alert.
     *
     * @param AlertLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AlertLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alert|array The loaded Alert as an assoc-array at the
