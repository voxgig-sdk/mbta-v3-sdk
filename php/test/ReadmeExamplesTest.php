...
// MbtaV3 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MbtaV3SDK::test)
...
{
    private const SDK_CLASS = 'MbtaV3SDK';
    ...
    private const SDK_BASE = 'mbtav3_sdk';
