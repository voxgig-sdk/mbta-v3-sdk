...
{
    private static function utility(): MbtaV3Utility
    {
        return new MbtaV3Utility();
    }
    ...
    private static function ctx(array $over = []): MbtaV3Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MbtaV3Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MbtaV3Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MbtaV3Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MbtaV3Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MbtaV3MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MbtaV3Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MbtaV3MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MbtaV3Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MbtaV3MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MbtaV3Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MbtaV3MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MbtaV3Response([]),
            'result' => new MbtaV3Result([]),
        ]);
        [, $err] = MbtaV3MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MbtaV3Spec(['step' => 's']),
            'response' => new MbtaV3Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MbtaV3Result([]),
        ]);
        [, $err] = MbtaV3MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MbtaV3Spec(['step' => 's']),
            'response' => new MbtaV3Response(self::resp(200, ['v' => 1])),
            'result' => new MbtaV3Result([]),
        ]);
        [, $err] = MbtaV3MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MbtaV3Spec(['step' => 's']),
            'response' => new MbtaV3Response(self::resp(200, ['v' => 2])),
            'result' => new MbtaV3Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MbtaV3MakeResponse::call($ctx);
    ...
    {
        $preset = new MbtaV3Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MbtaV3Spec([]),
            'response' => new MbtaV3Response([]),
            'result' => new MbtaV3Result([]),
        ...
        [$got, $err] = MbtaV3MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MbtaV3Result([])]);
        [, $err] = MbtaV3MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MbtaV3Spec([]), 'result' => null]);
        [, $err] = MbtaV3MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MbtaV3Spec(['step' => 's']),
            'result' => new MbtaV3Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MbtaV3Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MbtaV3MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MbtaV3Spec(['step' => 's']),
            'result' => new MbtaV3Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MbtaV3Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MbtaV3MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MbtaV3Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MbtaV3Spec([]),
            'result' => new MbtaV3Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MbtaV3MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MbtaV3MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MbtaV3Error('boom', 'boom');
        $utility->fetcher = function (MbtaV3Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MbtaV3Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MbtaV3MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MbtaV3Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MbtaV3MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MbtaV3Response::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MbtaV3Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MbtaV3Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MbtaV3MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MbtaV3Response(self::resp(201));
        $ctx = self::ctx(['spec' => new MbtaV3Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MbtaV3MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MbtaV3MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MbtaV3MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MbtaV3Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MbtaV3Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MbtaV3Result(['ok' => false])]);
        $this->expectException(MbtaV3Error::class);
        MbtaV3Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MbtaV3Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MbtaV3MakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MbtaV3BaseFeature();
        $b = new MbtaV3BaseFeature();
        MbtaV3FeatureAdd::call($ctx, $a);
        MbtaV3FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MbtaV3BaseFeature
    {
        $f = new MbtaV3BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MbtaV3FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MbtaV3Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MbtaV3Spec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MbtaV3PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MbtaV3Response(['headers' => null]),
            'result' => new MbtaV3Result([]),
        ]);
        MbtaV3ResultHeaders::call($ctx);
