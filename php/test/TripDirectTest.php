...
class TripDirectTest extends TestCase
{
    public function test_direct_load_trip(): void
    {
        $setup = trip_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-trip", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
