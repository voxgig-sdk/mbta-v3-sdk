...
class TripEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MBTA_V3_TEST_TRIP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function trip_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MBTA_V3_TEST_TRIP_ENTID");
