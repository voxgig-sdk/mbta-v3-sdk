...
class StopEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MBTAV__TEST_STOP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function stop_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MBTAV__TEST_STOP_ENTID");
